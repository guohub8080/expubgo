...
const HotArea = (props: {
    ...
    const hotX = defaultTo(props.x, 0)
    const hotY = defaultTo(props.y, 0)
    const hotW = defaultTo(props.width, props.viewBoxW)
    const hotH = defaultTo(props.height, props.viewBoxH)
