...
const BlurSwitch = (props: {
    ...
    const beforeUrl = defaultTo(props.beforeUrl, getTextImgPic1(600, 800, "切换前"))
    const afterUrl = defaultTo(props.afterUrl, getTextImgPic1(600, 800, "切换后"))
    const blurAmount = defaultTo(props.blurAmount, 10)
    const fadeDuration = defaultTo(props.fadeDuration, 2)
